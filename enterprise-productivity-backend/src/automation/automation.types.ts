...
const channelField: WorkflowConfigField = {
  key: 'channelId',
  label: 'Channel',
  type: 'channel',
  required: false,
...
const projectField: WorkflowConfigField = {
  key: 'projectId',
  label: 'Project ID',
  type: 'text',
  required: false,
...
export const TRIGGER_META: WorkflowTriggerMeta[] = [
  {
    type: 'task_created',
    label: 'Task created',
  ...
  },
  {
    ...
    label: 'Task overdue',
    description:
      'Fires when a task with a due date passes its due date (checked hourly).',
    configFields: [
      {
        key: 'priority',
        label: 'Priority',
  ...
  },
  {
    ...
    description:
      'Fires when a milestone is marked delayed, or passes its due date (checked hourly).',
    configFields: [projectField],
  },
  {
    type: 'meeting_ended',
...
export const CONDITION_FIELD_META: WorkflowConditionFieldMeta[] = [
...
export const CONDITION_OPERATOR_META: WorkflowConditionOperatorMeta[] = [
  { key: 'eq', label: 'equals' },
...
export const ACTION_META: WorkflowActionMeta[] = [
  {
    type: 'notify',
  ...
  },
  {
    ...
    description:
      'Generate and store an AI summary (project or conversation) and notify recipients.',
    configFields: [
      {
        key: 'scope',
        label: 'Scope',
...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  {
    ...
    description:
      'When a task becomes overdue, remind the assignee and the creator.',
    workflow: {
  ...
  },
  {
    ...
    description:
      'When a meeting ends, generate an AI summary and create tasks from its action items.',
    workflow: {
  ...
  },
  {
    ...
    description:
      'When a project is created, post a welcome message in its channel.',
    workflow: {
  ...
  },
  {
    ...
    description:
      'When a milestone is delayed, notify the person who triggered it.',
    workflow: {
      ...
      actions: [
        {
          ...
          config: {
            ...
            description:
              'Milestone "{{title}}" is delayed and needs attention.',
            actionUrl: '/projects',
          },
        },
      ],
