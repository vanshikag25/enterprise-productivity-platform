...
let TranslationController = class TranslationController {
    ...
    translate(auth, dto) {
        ...
        return this.translationService.translate(dto.channelId, dto.messageId, auth.userId, dto.targetLanguage);
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, translate_message_dto_1.TranslateMessageDto]),
    __metadata("design:returntype", Promise)
], TranslationController.prototype, "translate", null);
exports.TranslationController = TranslationController = __decorate([
    (0, common_1.Controller)('chat/translate'),
