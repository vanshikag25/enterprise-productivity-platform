...
exports.meetings = (0, pg_core_1.pgTable)('meetings', {
    ...
    attachments: (0, pg_core_1.jsonb)('attachments').$type().notNull().default([]),
    recordingLink: (0, pg_core_1.varchar)('recording_link', { length: 500 }),
    meetingCode: (0, pg_core_1.varchar)('meeting_code', { length: 32 }),
